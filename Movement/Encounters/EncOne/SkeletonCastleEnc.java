...
public class SkeletonCastleEnc extends Encounter {
	...
	public void onDeath() {
		Kronk.print("YOU HAVE KILLED THE SKELETONS, AS ITS JAW COLLAPSES TO THE GROUND, THE MAGIC THAT\n"
				+ "WAS HOLDING IT TOGETHER HAS LOST ITS GRASP ON THE SKELETON, AND THE SKELETON "
				+ "RETURNS TO A PILE OF BONES THE SKELETON IS DEAD AGAIN...\n");
	}
