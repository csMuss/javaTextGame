...
public class SkeletonCastleEnc extends Encounter {
	...
	public void onDeath() {
		Kronk.print("THE SKELETONS JAW COLLAPSES TO THE GROUND, THE MAGIC THAT WAS HOLDING IT TOGETHER\n"
				+ "HAS LOST ITS GRASP ON THE SKELETON, AND THE SKELETON RETURNS TO A PILE OF BONES...\n");
	}
